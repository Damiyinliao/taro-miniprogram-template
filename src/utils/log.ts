/**
 * @description 美化打印（https://juejin.cn/post/7371716384847364147?searchId=2024061309430828B0D01180A10039BB6D）
 * @returns
 */
const prettyLog = () => {
  ...
  const origin = (textOrTitle: string, value: any) => {
    if (isProduction) return;
    console.log(textOrTitle, value);
  }
  // retu;
  return {
    info,
